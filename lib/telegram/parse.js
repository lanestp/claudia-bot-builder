...
console.log(messageObject);
  ...
  if (messageObject && messageObject.callback_query && messageObject.callback_query.message && messageObject.callback_query.message.chat &&
  ...
  if (messageObject && messageObject.callback_query && messageObject.callback_query.from ){
    var callback_query = messageObject.callback_query;
    return {
